  ...
  return (
    <main className="flex-1 bg-brand-background px-6 py-16">
      <div className="mx-auto max-w-2xl">
        <h1 className="font-heading mb-6 text-2xl font-semibold text-foreground">{t("addEvent")}</h1>
        <EventForm apiUrl={apiUrl} sports={sportOptions} venues={venueOptions} mode="create" />
      </div>
    </main>
  );
}
