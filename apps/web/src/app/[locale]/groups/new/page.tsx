  ...
  return (
    <main className="flex-1 bg-brand-background px-6 py-16">
      <div className="mx-auto max-w-2xl">
        <h1 className="font-heading mb-6 text-2xl font-semibold text-foreground">{t("addGroup")}</h1>
        <ClubForm apiUrl={apiUrl} cities={cityOptions} sports={sportOptions} mode="create" kind="Group" />
      </div>
    </main>
  );
}
